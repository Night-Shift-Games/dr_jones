...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnGlobalQuestDelegate, UQuest*, Quest);
...
public:
	...
	UPROPERTY(BlueprintAssignable)
	FOnGlobalQuestDelegate OnGlobalQuestAdded;

	UPROPERTY(BlueprintAssignable)
	FOnGlobalQuestDelegate OnGlobalQuestCompleted;
