...
namespace Utilities
{
	...
	FVector FindGround(const UObject& WorldContextObject, const FVector& StartLocation, const TArray<const AActor*>& ActorsToIgnore = {}, ECollisionChannel Channel = ECC_Visibility);
