...
namespace Utilities
{
	...
	FHitResult FindGround(const UObject& WorldContextObject, const FVector& StartLocation, const TArray<const AActor*>& ActorsToIgnore = {});
...
public:
	...
	{ return WorldContextObject ? Utilities::FindGround(*WorldContextObject, StartLocation).Location : FVector::ZeroVector; }
